...
rebuild_firmware() {
    ...
    # Keep the firmware minimal: use ImageBuilder default packages and only add
    # packages listed in config/imagebuilder/config.
...
download_imagebuilder
adjust_settings
# Keep this build minimal; do not download extra luci-app-amlogic packages.
custom_config
custom_files
rebuild_firmware
custom_settings
